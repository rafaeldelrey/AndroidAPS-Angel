...
import info.nightscout.androidaps.plugins.aps.Angel.DetermineBasalAdapterAngelJS
import info.nightscout.androidaps.plugins.aps.Angel.DetermineBasalResultAngel
...
abstract class APSModule {
    ...
    @ContributesAndroidInjector abstract fun determineBasalResultAngelInjector(): DetermineBasalResultAngel
    ...
    @ContributesAndroidInjector abstract fun determineBasalAdapterAngelInjector(): DetermineBasalAdapterAngelJS
}