...
class DetermineBasalAdapterAngelJS internal constructor(private val scriptReader: ScriptReader, private val injector: HasAndroidInjector) : DetermineBasalAdapterInterface {
    ...
    override operator fun invoke(): APSResult? {
        ...
        var determineBasalResultAngel: DetermineBasalResultAngel? = null
        ...
        try {
            ...
            rhino.evaluateString(scope, readFile("Angel/determine-basal.js"), "JavaScript", 0, null)
            rhino.evaluateString(scope, readFile("Angel/basal-set-temp.js"), "setTempBasal.js", 0, null)
            ...
            if (determineBasalObj is Function && setTempBasalFunctionsObj is NativeObject) {
                ...
                try {
                    ...
                    determineBasalResultAngel = DetermineBasalResultAngel(injector, resultJson)
        ...
        return determineBasalResultAngel
    }
    ...
    override fun setData(
        ...
        this.profile.put("high_temptarget_raises_sensitivity", sp.getBoolean(R.string.key_high_temptarget_raises_sensitivity, AngelDefaults.high_temptarget_raises_sensitivity))
        // this.profile.put("high_temptarget_raises_sensitivity", false)
        this.profile.put("low_temptarget_lowers_sensitivity", sp.getBoolean(R.string.key_low_temptarget_lowers_sensitivity, AngelDefaults.low_temptarget_lowers_sensitivity))
