...
class DetermineBasalResultAngel private constructor(injector: HasAndroidInjector) : APSResult(injector) {
    ...
    override fun newAndClone(injector: HasAndroidInjector): DetermineBasalResultAngel {
        val newResult = DetermineBasalResultAngel(injector)
        doClone(newResult)
