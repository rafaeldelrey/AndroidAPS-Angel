...
import info.nightscout.androidaps.plugins.aps.Angel.AngelPlugin
...
class SafetyPlugin @Inject constructor(
    ...
    private val AngelPlugin: AngelPlugin,
    ...
    override fun applyMaxIOBConstraints(maxIob: Constraint<Double>): Constraint<Double> {
        ...
        val maxIobPref: Double = if (openAPSSMBPlugin.isEnabled() || openAPSSMBDynamicISFPlugin.isEnabled() || AngelPlugin.isEnabled()) sp.getDouble(R.string.key_openapssmb_max_iob, 3.0) else sp.getDouble(R.string
        ...
        if (AngelPlugin.isEnabled()) maxIob.setIfSmaller(aapsLogger, hardLimits.maxIobAngel(), String.format(rh.gs(R.string.limitingiob), hardLimits.maxIobAngel(), rh.gs(R.string.hardlimit)), this)
